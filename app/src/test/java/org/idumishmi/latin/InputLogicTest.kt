...
import org.idumishmi.keyboard.ShadowInputMethodManager2
import org.idumishmi.keyboard.ShadowLocaleManagerCompat
...
import org.idumishmi.keyboard.latin.ShadowFacilitator2.Companion.lastAddedWord
...
import org.idumishmi.keyboard.latin.inputlogic.SpaceState
import org.idumishmi.keyboard.latin.settings.Settings
import org.idumishmi.keyboard.latin.utils.ScriptUtils
import org.idumishmi.keyboard.latin.utils.getTimestamp
...
class InputLogicTest {
    ...
    //  https://github.com/akki2825/idu_keyboard/issues/214
...
//        assertEquals("example.cz", composingText) // fails, but probably would be better than above
    ...
    // https://github.com/akki2825/idu_keyboard/issues/215
    // https://github.com/akki2825/idu_keyboard/issues/229
    ...
    // https://github.com/akki2825/idu_keyboard/issues/230
