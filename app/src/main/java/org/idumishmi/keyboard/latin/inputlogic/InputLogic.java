...
package org.idumishmi.keyboard.latin.inputlogic;
...
import org.idumishmi.keyboard.latin.LastComposedWord;
import org.idumishmi.keyboard.latin.LatinIME;
import org.idumishmi.keyboard.latin.NgramContext;
import org.idumishmi.keyboard.latin.RichInputConnection;
import org.idumishmi.keyboard.latin.Suggest;
...
import org.idumishmi.keyboard.latin.WordComposer;
...
import org.idumishmi.keyboard.latin.common.StringUtilsKt;
import org.idumishmi.keyboard.latin.common.SuggestionSpanUtilsKt;
import org.idumishmi.keyboard.latin.define.DebugFlags;
import org.idumishmi.keyboard.latin.settings.SettingsValues;
import org.idumishmi.keyboard.latin.settings.SpacingAndPunctuations;
import org.idumishmi.keyboard.latin.suggestions.SuggestionStripViewAccessor;
import org.idumishmi.keyboard.latin.utils.AsyncResultHolder;
import org.idumishmi.keyboard.latin.utils.InputTypeUtils;
import org.idumishmi.keyboard.latin.utils.Log;
import org.idumishmi.keyboard.latin.utils.RecapitalizeStatus;
import org.idumishmi.keyboard.latin.utils.ScriptUtils;
import org.idumishmi.keyboard.latin.utils.StatsUtils;
import org.idumishmi.keyboard.latin.utils.TextRange;
import org.idumishmi.keyboard.latin.utils.TimestampKt;
...
public final class InputLogic {
     ...
     *     {@link org.idumishmi.keyboard.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    private void handleNonSeparatorEvent(final Event event, final SettingsValues settingsValues,
        ...
        if (isComposingWord) {
            ...
            if (swapWeakSpace && trySwapSwapperAndSpace(event, inputTransaction)) {
                ...
                // weird issue when committing text: https://github.com/akki2825/idu_keyboard/issues/585
    ...
    private void handleBackspaceEvent(final Event event, final InputTransaction inputTransaction,
        ...
        if (mWordComposer.isComposingWord()) {
            ...
            //  see https://github.com/akki2825/idu_keyboard/issues/1019
    ...
    /**
     * Make a {@link org.idumishmi.keyboard.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link org.idumishmi.keyboard.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, org.idumishmi.keyboard.latin.SuggestedWords)}.
