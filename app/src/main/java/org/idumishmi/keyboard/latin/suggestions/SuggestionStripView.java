...
import static org.idumishmi.keyboard.latin.utils.ToolbarUtilsKt.*;
...
import org.idumishmi.keyboard.keyboard.PopupKeysPanel;
...
import org.idumishmi.keyboard.latin.suggestions.PopupSuggestionsView.MoreSuggestionsListener;
...
import org.idumishmi.keyboard.latin.utils.ToolbarUtilsKt;
...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    public void onVisibilityChanged(@NonNull final View view, final int visibility) {
        ...
        if (view == this)
            // workaround for a bug with inline suggestions views that just keep showing up otherwise, https://github.com/akki2825/idu_keyboard/pull/386
