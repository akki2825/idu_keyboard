...
import org.idumishmi.keyboard.latin.common.UnicodeSurrogate;
import org.idumishmi.keyboard.latin.inputlogic.PrivateCommandPerformer;
...
import org.idumishmi.keyboard.latin.utils.DebugLogUtils;
import org.idumishmi.keyboard.latin.utils.NgramContextUtils;
import org.idumishmi.keyboard.latin.utils.ScriptUtils;
import org.idumishmi.keyboard.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See org.idumishmi.keyboard.latin.common.Constants.UnicodeSurrogate
    ...
    public boolean setComposingText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            if (!Settings.getValues().mInputAttributes.mShouldShowSuggestions && text.length() > 0) {
                ...
                // This might lead to weird bugs (e.g. https://github.com/akki2825/idu_keyboard/issues/225), so better do
