...
import org.idumishmi.keyboard.latin.common.loopOverCodePoints
import org.idumishmi.keyboard.latin.common.loopOverCodePointsBackwards
...
class KeyboardActionListenerImpl(private val latinIME: LatinIME, private val inputLogic: InputLogic) : KeyboardActionListener {
    ...
    private fun onMoveCursorHorizontally(rawSteps: Int): Boolean {
        ...
        //     https://github.com/akki2825/idu_keyboard/issues/1139#issuecomment-2588169384
